...
export function AppSidebarHeader({
    ...
    return (
        <header className="flex h-16 shrink-0 items-center gap-2 border-b border-white/20 bg-[var(--color-primary)] px-6 text-white transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 md:px-4">
